...
convar_category 'PMA-Voice' {
	"PMA-Voice Configuration Options",
	{
		...
		{ "Enable F10 proximity key",              "$voice_enableProximityCycle", "CV_INT",    "1" },
		{ "Sprachreichweite",                   "$voice_defaultCycle",         "CV_STRING", "F10" },
		...
		{ "Funken",                             "$voice_defaultRadio",         "CV_STRING", "CAPSLOCK" },
